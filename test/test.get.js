...
tape( 'attached to the prototype of the main export is a `get` method for returning an array element', function test( t ) {
	t.strictEqual( hasOwnProp( Int64Array.prototype, 'get' ), true, 'has property' );
	t.strictEqual( isFunction( Int64Array.prototype.get ), true, 'has method' );
	t.end();
});
