...
import { ArrayLike, Int64Array as Int64ArrayInterface } from '@stdlib/types/array';
...
// Define a type representing a value from which a 64-bit signed integer can be derived:
type Int = Int64 | bigint | number;
...
* @returns transformed value
*/
type FromUnary<U> = ( this: U, value: Int ) => Int;
...
* @returns transformed value
*/
type FromBinary<U> = ( this: U, value: Int, index: number ) => Int;
...
* @returns boolean indicating whether an element in an array passes a test
*/
type UnaryPredicate<U> = ( this: U, value: Int64 ) => boolean;
...
* @returns boolean indicating whether an element in an array passes a test
*/
type BinaryPredicate<U> = ( this: U, value: Int64, index: number ) => boolean;
...
* @returns boolean indicating whether an element in an array passes a test
*/
type TernaryPredicate<U> = ( this: U, value: Int64, index: number, arr: Int64Array ) => boolean;
...
* @returns undefined
*/
type UnaryCallback<U> = ( this: U, value: Int64 ) => void;
...
* @returns undefined
*/
type BinaryCallback<U> = ( this: U, value: Int64, index: number ) => void;
...
* @returns undefined
*/
type TernaryCallback<U> = ( this: U, value: Int64, index: number, arr: Int64Array ) => void;
...
* @returns transformed value
*/
type NullaryMapFcn<U> = ( this: U ) => Int;
...
* @returns transformed value
*/
type UnaryMapFcn<U> = ( this: U, value: Int64 ) => Int;
...
* @returns transformed value
*/
type BinaryMapFcn<U> = ( this: U, value: Int64, index: number ) => Int;
...
* @returns transformed value
*/
type TernaryMapFcn<U> = ( this: U, value: Int64, index: number, arr: Int64Array ) => Int;
...
* @returns accumulated result
*/
type BinaryReducer<U> = ( acc: U, value: Int64 ) => U;
...
* @returns accumulated result
*/
type TernaryReducer<U> = ( acc: U, value: Int64, index: number ) => U;
...
* @returns accumulated result
*/
type QuaternaryReducer<U> = ( acc: U, value: Int64, index: number, arr: Int64Array ) => U;
...
*/
type CompareFcn = ( a: Int64, b: Int64 ) => number;

/**
* Class for creating a 64-bit signed integer array.
*/
declare class Int64Array implements Int64ArrayInterface {
	/**
	...
	* @throws an array element must be either a 64-bit signed integer or a value which can be converted to a 64-bit signed integer
	* @throws an iterator must return either a 64-bit signed integer or a value which can be converted to a 64-bit signed integer
	* @returns 64-bit signed integer array
	*
	* @example
	...
	* // returns 2
	*/
	constructor( arg?: number | ArrayLike<Int> | Int64Array | ArrayBuffer | Iterable<Int>, byteOffset?: number, length?: number );
	...
	* // returns true
	*/
	entries(): TypedIterator<[number, Int64]>;
	...
	* // returns <Int64>[ 1n ]
	*/
	set( value: ArrayLike<Int> | Int64Array | Int, i?: number ): void;
}

/**
* Interface defining a 64-bit signed integer array constructor which is both "newable" and "callable".
*/
interface Int64ArrayConstructor {
	/**
	* 64-bit signed integer array constructor.
	*
	* @param arg - length, typed array, array-like object, or buffer
	...
	*
	* var buf = new ArrayBuffer( 16 );
	* var arr = new Int64Array( buf, 8 );
	* // returns <Int64Array>[ 0n ]
	*
	* var len = arr.length;
	* // returns 1
	*
	...
	* // returns 2
	*/
	new( arg?: number | ArrayLike<Int> | Int64Array | ArrayBuffer | Iterable<Int>, byteOffset?: number, length?: number ): Int64Array;
	...
	* // returns 2
	*/
	( arg?: number | ArrayLike<Int> | Int64Array | ArrayBuffer | Iterable<Int>, byteOffset?: number, length?: number ): Int64Array;
	...
	* @throws an array element must be either a 64-bit signed integer or a value which can be converted to a 64-bit signed integer
	* @throws an iterator must return either a 64-bit signed integer or a value which can be converted to a 64-bit signed integer
	* @throws when provided an iterator, a callback must return either a 64-bit signed integer or a value which can be converted to a 64-bit signed integer
	* @returns 64-bit signed integer array
	*
	* @example
	* var arr = Int64Array.from( [ 1 ] );
	* // returns <Int64Array>[ 1n ]
	*
	* var len = arr.length;
	* // returns 1
	...
	* }
	*
	* var arr = Int64Array.from( [ 1, 2 ], clbk );
	* // returns <Int64Array>[ 2n, 4n ]
	*
	* var len = arr.length;
	* // returns 2
	*/
	from<U = unknown>( src: ArrayLike<Int> | Int64Array | Iterable<Int>, clbk?: FromCallback<U>, thisArg?: ThisParameterType<FromCallback<U>> ): Int64Array;
	...
	* // returns 4
	*/
	of( ...elements: Array<Int> ): Int64Array;
}
...
* // returns 2
*/
declare var ctor: Int64ArrayConstructor;
...
// eslint-doctest-alias: Int64Array
