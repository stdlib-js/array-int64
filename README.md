...
```javascript
Int64Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-int64@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var Int64Array = require( 'path/to/vendor/umd/array-int64/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-int64@umd/browser.js"></script>
```
...
Creates a 64-bit signed integer array.
...
Creates a 64-bit signed integer array having a specified length.

```javascript
var arr = new Int64Array( 5 );
// returns <Int64Array>[ 0n, 0n, 0n, 0n, 0n ]
```

#### Int64Array( typedarray )

Creates a 64-bit signed integer array from another [typed array][mdn-typed-array].

```javascript
var Uint32Array = require( '@stdlib/array-uint32' );

var arr1 = new Uint32Array( [ 5, 5, 5 ] );
var arr2 = new Int64Array( arr1 );
// returns <Int64Array>[ 5n, 5n, 5n ]
```

#### Int64Array( obj )

Creates a 64-bit signed integer array from an array-like object or iterable.

```javascript
var arr = new Int64Array( [ 5.0, -5.0, 5.0 ] );
// returns <Int64Array>[ 5n, -5n, 5n ]
```

#### Int64Array( buffer\[, byteOffset\[, length]] )

Returns a 64-bit signed integer array view of an [`ArrayBuffer`][@stdlib/array/buffer].

```javascript
var ArrayBuffer = require( '@stdlib/array-buffer' );

var buf = new ArrayBuffer( 32 );
var arr = new Int64Array( buf, 0, 4 );
...
```javascript
var str = Int64Array.name;
// returns 'Int64Array'
```

<a name="prop-buffer"></a>

#### Int64Array.prototype.buffer
...
#### Int64Array.prototype.byteLength
...
#### Int64Array.prototype.byteOffset
...
#### Int64Array.prototype.BYTES_PER_ELEMENT
...
var arr = Int64Array.from( [ -1, 2 ], mapFcn );
// returns <Int64Array>[ -2n, 4n ]
```
...
var arr = Int64Array.from( [ 1, -2 ], mapFcn, ctx );
// returns <Int64Array>[ 2n, -4n ]
...
#### Int64Array.of( element0\[, element1\[, ...elementN]] )

Creates a new 64-bit signed integer array from a variable number of arguments.

```javascript
var arr = Int64Array.of( 1, 2 );
// returns <Int64Array>[ 1n, 2n ]
```

<a name="method-at"></a>

#### Int64Array.prototype.at( i )
...
#### Int64Array.prototype.set( value\[, i] )
...
In addition to providing a scalar value (e.g., integer, [`bigint`][@stdlib/bigint/ctor], or [`Int64`][@stdlib/number/int64/ctor]), to set one or more array elements, provide an array-like object containing scalar values
...
-   While an `Int64Array` _strives_ to maintain (but does not **guarantee**) consistency with [typed arrays][@stdlib/array/typed], significant deviations from ECMAScript-defined [typed array][@stdlib/array/typed] behavior are as follows:

    -   The constructor does **not** require the `new` operator.
    -   The constructor and associated methods support a broader variety of input argument types in order to better accommodate signed integer input.
    -   Accessing array elements using bracket syntax (e.g., `X[i]`) is **not** supported. Instead, one **must** use the `.get()` method.
    -   The `set` method has extended behavior in order to support 64-bit signed integer instances.
...
// Create a 64-bit signed integer array by specifying a length:
var out = new Int64Array( 3 );
logEach( '%s', out );

// Create a 64-bit signed integer array from an array of 64-bit signed integer numbers:
var arr = [
    new Int64( 1 ),
    new Int64( -2 ),
    new Int64( 3 )
];
out = new Int64Array( arr );
logEach( '%s', out );

// Create a 64-bit signed integer array from a typed array:
arr = new Uint32Array( [ 1, 2, 3, 4 ] );
out = new Int64Array( arr );
logEach( '%s', out );

// Create a 64-bit signed integer array from an array buffer, where underlying storage consists of interleaved high and low 32-bit words:
arr = new Uint32Array( [ 1, 2, 3, 4 ] );
out = new Int64Array( arr.buffer );
logEach( '%s', out );

// Create a 64-bit signed integer array from an array buffer view, where underlying storage represents each 64-bit integer as interleaved high and low 32-bit words:
arr = new Uint32Array( [ 1, 2, 3, 4, 5, 6, 7, 8 ] );
out = new Int64Array( arr.buffer, 16, 2 );
logEach( '%s', out );
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/array-int64.svg
[npm-url]: https://npmjs.org/package/@stdlib/array-int64

[test-image]: https://github.com/stdlib-js/array-int64/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/array-int64/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/array-int64/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/array-int64?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/array-int64.svg
[dependencies-url]: https://david-dm.org/stdlib-js/array-int64/main
...
[deno-url]: https://github.com/stdlib-js/array-int64/tree/deno
[deno-readme]: https://github.com/stdlib-js/array-int64/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/array-int64/tree/umd
[umd-readme]: https://github.com/stdlib-js/array-int64/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/array-int64/tree/esm
[esm-readme]: https://github.com/stdlib-js/array-int64/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/array-int64/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/array-int64/main/LICENSE
...
[@stdlib/array/uint64]: https://github.com/stdlib-js/array-uint64/tree/umd
